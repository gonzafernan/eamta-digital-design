...
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { clock }]; # fclk=100MHz
#create_clock -add -name sys_clk_pin -period 6.67 -waveform {0 3.33} [get_ports { clock }]; # fclk=150MHz
create_clock -add -name sys_clk_pin -period 5.00 -waveform {0 2.5} [get_ports { clock }]; # fclk=200MHz
